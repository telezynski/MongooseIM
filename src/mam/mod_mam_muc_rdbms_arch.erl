...
archive_message(_Result, Host, MessID, RoomID, BareSenderJID = #jid{},
                _RemJID = #jid{}, UserRoomJID = #jid{}, incoming, Packet) ->
    try
        Row = prepare_message(Host, MessID, RoomID, BareSenderJID, UserRoomJID, Packet),
...
prepare_message(Host, MessID, RoomID, BareSenderJID, #jid{ lresource = FromNick }, Packet) ->
